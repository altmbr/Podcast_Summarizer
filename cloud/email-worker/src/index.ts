...
export default {
  async email(message: ForwardableEmailMessage, env: Env, ctx: ExecutionContext) {
    ...
    try {
      ...
      const isTransactional = /confirm|verif|activate|subscribe|opt.?in|double.?opt|welcome|thank you|thanks for|on the list|your (account|registration|signup)|getting started|verification code/i.test(subject)
